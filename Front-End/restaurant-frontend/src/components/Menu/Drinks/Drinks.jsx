  ...
  useEffect(() => {
    const fetchItems = async () => {
      try {
        ...
        console.error("Error fetching drinks items:", err);
      } finally {
        setLoading(false); 
      }
    };
  ...
  return (
    <div className="menu-page !bg-[#111827]">
      ...
      <div className="menu-header">
        <h1 className="!text-4xl !font-bold !text-[#F9FAFB]">Drinks Menu {"\ud83e\udd64"}</h1>
        <p className="!text-[#9CA3AF]">
          Cool, refreshing or hot drinks to match every mood.
        </p>
      </div>
