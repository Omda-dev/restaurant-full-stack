  ...
  return (
    <div className="menu-page !bg-[#111827]">
      ...
      <div className="menu-header">
        <h1 className="!text-4xl !font-bold !text-[#F9FAFB]">Lunch Specials {"\ud83c\udf72"}</h1>
        <p className="!text-[#9CA3AF]">
          Midday cravings deserve something hearty! Fresh, flavorful dishes to keep you energized.
        </p>
      </div>
